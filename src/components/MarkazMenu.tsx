/**
 * MarkazMenu.tsx — Premium tile-based navigation hub for the Markaz section.
 *
 * Follows the same pattern as TajneedMenu and CensusMenu (DRY).
 */
...
const tiles: Tile[] = [
    {
        ...
        icon: Building2,
        title: 'Markaz Data',
        desc: 'View headquarters-related data and records',
        path: '/markaz/data',
        color: 'bg-brand',
    },
    {
        ...
        icon: BarChart3,
        title: 'Analytics',
        desc: 'Visualise trends and insights',
        path: '',
        color: 'bg-amber-500',
        badge: 'Coming Soon',
    },
    {
        ...
        icon: FileText,
        title: 'Reports',
        desc: 'Generate and export summary reports',
        path: '',
        color: 'bg-blue-500',
        badge: 'Coming Soon',
    },
    {
        ...
        icon: Settings,
        title: 'Settings',
        desc: 'Configure markaz parameters',
        path: '',
        color: 'bg-slate-500',
        badge: 'Coming Soon',
    },
        ...
        <div className="flex h-full flex-col overflow-y-auto bg-slate-50 dark:bg-slate-900">
            <div className="mx-auto w-full max-w-5xl px-6 py-10">
                ...
                >
                    ...
                    <p className="mt-1 text-sm text-slate-500 dark:text-slate-400">
                        Headquarters data and management
                    </p>
                </motion.div>
